      ...
      <div class="md:flex md:items-center md:justify-between">
        <div class="flex justify-between items-center">
          <div class="text-xl font-semibold text-gray-700">
            <a href='{{ route('home') }}'
              class="text-gray-800 text-xl font-bold hover:text-gray-700 md:text-2xl">Programmers
              Home</a>
          </div>
        ...
        <div class="hidden md:flex md:items-center md:justify-between flex-1">
          <div class="flex flex-col -mx-4 md:flex-row md:items-center md:mx-8">
            <a href="{{ route('posts.index') }}"
              class="mx-2 mt-2 md:mt-0 px-2 py-1 text-sm text-gray-700 font-medium rounded-md hover:text-indigo-500 hover:bg-white {{ Route::is('posts.index') ? 'text-indigo-500' : '' }} ">Posts</a>
            <a href="{{ route('posts.create') }}"
              class="mx-2 mt-2 md:mt-0 px-2 py-1 text-sm text-gray-700 font-medium rounded-md hover:text-indigo-500 {{ Route::is('posts.create') ? 'text-indigo-500' : '' }} hover:bg-white ">Share
              Post</a>
          </div>
          ...
          <div class="flex items-center mt-4 md:mt-0">
            ...
            <button type="button" class="flex items-center focus:outline-none" aria-label="toggle profile dropdown">
              <div class="h-8 w-8 overflow-hidden rounded-full border-2  border-gray-400">
                <img src="https://lh3.googleusercontent.com/a-/AOh14Gi0DgItGDTATTFV6lPiVrqtja6RZ_qrY91zg42o-g"
